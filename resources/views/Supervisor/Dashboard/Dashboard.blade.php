@extends('Supervisor.Dashboard.Layouts.Header')
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-800 overflow-hidden mb-6 dark:text-gray-50">
            ...
            <div class="overflow-x-auto px-4 sm:px-6">
                ...
                <div class="w-full max-w-full overflow-x-auto">
                    <table class="data-table w-full text-center border border-collapse rounded-lg overflow-hidden"
                        id="salesmanTable">
                        <thead>
            ...
            <!-- Pagination -->
            <div
                class="p-6 border-gray-200 dark:border-gray-600 flex flex-col sm:flex-row justify-between items-center gap-3">
