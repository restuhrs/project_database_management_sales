...
<!-- Navbar -->
@include('Salesman.SavedData.Layouts.Sidebar')

@yield('content')

<!-- Footer -->
@include('Salesman.SavedData.Layouts.Footer')
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const jenisPelangganFilter = document.getElementById('JenisPelangganFilter');
        ...
        function filterTableData() {
            ...
            const selectedJenisPelanggan = jenisPelangganFilter.value;
            ...
            return tableData.filter(item => {
                ...
                const matchesJenisPelanggan = !selectedJenisPelanggan || item.jenisPelanggan === selectedJenisPelanggan;

                return matchesSearch && matchesBranch && matchesCity && matchesProgress && matchesJenisPelanggan;
            });
        }
        ...
        jenisPelangganFilter.addEventListener('change', function () {
            currentPage = 1;
            const filteredData = filterTableData();
            updateTableDisplay(filteredData);
        });
