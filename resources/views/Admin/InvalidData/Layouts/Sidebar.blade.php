                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.dashboard') }}"
                            ...
                            <span class="material-symbols-outlined dark:text-gray-400">dashboard</span>
                    ...
                    <li x-data="{ dropdownOpen: false }"
                        x-on:mouseenter="if(document.body.classList.contains('sidebar-collapsed') && window.innerWidth >= 769) dropdownOpen = true"
                        x-on:mouseleave="if(document.body.classList.contains('sidebar-collapsed') && window.innerWidth >= 769) dropdownOpen = false"
                        :class="{ 'dropdown-open': dropdownOpen }">
                        <button
                            @click="if(!document.body.classList.contains('sidebar-collapsed') || window.innerWidth < 769) dropdownOpen = !dropdownOpen"
                            class="flex items-center w-full p-2 text-base font-medium bg-opacity-10 bg-blue-600 text-blue-700 rounded-lg dark:text-blue-300">
                            <span class="material-symbols-outlined ">
                                database
                            </span>
                            <span class="flex-1 ml-3 text-left whitespace-nowrap sidebar-text">Master Data</span>
                            <span class="dropdown-arrow material-symbols-outlined">expand_more</span>
                        </button>
                        <ul x-show="dropdownOpen" class="py-2 space-y-2 pl-11 dropdown-content">
                            <li>
                                <a href="{{ route('admin.bigdata') }}"
                                    class="flex items-center p-2 text-sm font-medium  text-gray-900 rounded-lg hover:bg-gray-100 dark:text-gray-100 dark:hover:bg-gray-700">
                                    <span class="material-symbols-outlined text-sm">list_alt</span>
                                    <span class="ml-3 sidebar-text">Big Data</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.invaliddata') }}"
                                    class="flex items-center p-2 text-sm font-medium bg-opacity-10 bg-blue-600 text-blue-700 rounded-lg dark:text-blue-300">
                                    <span
                                        class="material-symbols-outlined text-sm dark:text-gray-400">error_outline</span>
                                    <span class="ml-3 sidebar-text">Invalid Data</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li x-data="{ dropdownOpen: false }"
                        ...
                        <button
                            @click="if(!document.body.classList.contains('sidebar-collapsed') || window.innerWidth < 769) dropdownOpen = !dropdownOpen"
                            class="flex items-center w-full p-2 text-base font-medium text-gray-900 rounded-lg hover:bg-gray-100 dark:text-gray-100 dark:hover:bg-gray-700">
                            <span class="material-symbols-outlined dark:text-gray-400">manage_accounts</span>
                            <span class="flex-1 ml-3 text-left whitespace-nowrap sidebar-text">Manage Account</span>
                            <span class="dropdown-arrow material-symbols-outlined">expand_more</span>
                        </button>
                        <ul x-show="dropdownOpen" class="py-2 space-y-2 pl-11 dropdown-content">
                            <li>
                                <a href="{{ route('admin.usermanagement') }}"
                                    class="flex items-center p-2 text-sm font-medium text-gray-900 rounded-lg hover:bg-gray-100 dark:text-gray-100 dark:hover:bg-gray-700">
                                    <span class="material-symbols-outlined text-sm dark:text-gray-400">people_alt</span>
                ...
                <div class="px-4 py-3 flex items-center justify-between md:py-4 lg:py-5">
                    ...
                    <div class="flex items-center">
                        ...
                        <button @click="sidebarOpen = !sidebarOpen"
                            class="nav-icon lg:hidden dark:text-white border dark:border-gray-700 border-gray-200 w-8 h-8 md:w-10 md:h-10">
                        ...
                        <span class="text-lg font-semibold text-gray-800 dark:text-white ml-4">Invalid Data</span>
                    </div>
